...
using EquipmentSystem.Configuration.Ui;
using EquipmentSystem.Sessions;
using EquipmentSystem.Web.Models;
using EquipmentSystem.Web.Models.Layout;

namespace EquipmentSystem.Web.Controllers
{
    public class LayoutController : EquipmentSystemControllerBase
    {
